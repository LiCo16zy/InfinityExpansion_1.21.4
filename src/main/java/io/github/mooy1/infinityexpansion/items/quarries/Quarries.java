...
public final class Quarries {
    ...
    public static final SlimefunItemStack GLOD_OSCILLATOR = Oscillator.create(Material.GOLD_INGOT, GOLD_CHANCE);
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        if (section.getBoolean("gold")) {
            new Oscillator(GLOD_OSCILLATOR, GOLD_CHANCE).register(plugin);
