...
public final class Blocks {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new AdvancedAnvil(Groups.ADVANCED_MACHINES, ADVANCED_ANVIL, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
        ...
        new InfinityWorkbench(Groups.ADVANCED_MACHINES, INFINITY_FORGE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
